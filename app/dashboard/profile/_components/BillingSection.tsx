      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wide ${meta.badgeClass}`}>
                  {meta.label}
                </span>
                {hasActivePlan && !isCanceled && (
                  <span className="inline-flex items-center gap-1 text-xs text-green-600 dark:text-green-400">
                    <CheckCircle2 className="w-3 h-3" /> {isRo ? "Activ" : "Active"}
                  </span>
                )}
                {isCanceled && (
