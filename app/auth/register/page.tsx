...
export default function RegisterPage() {
  ...
  return (
    <AuthCard
      title={isRo ? "Creeaza un cont" : "Create an account"}
      subtitle={isRo ? "Incepe sa-ti organizezi mai bine intolerantele alimentare." : "Start organizing your food intolerances better."}
      description={
        isRo
          ? "Contul tau iti permite sa salvezi intolerantele, preferintele si jurnalul personal."
          : "Your account lets you save intolerances, preferences and personal journal entries."
      }
      footer={
        <>
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <FormField
          label={isRo ? "Confirma parola" : "Confirm password"}
          required
          ...
          <Checkbox
            ...
            label={
              <>
                ...
                >
                  {isRo ? "Termenii si Conditiile" : "Terms and Conditions"}
                </Link>{" "}
                {isRo ? "si " : "and "}
                <Link
        ...
        <Button type="submit" loading={loading} fullWidth size="lg">
          {loading ? (isRo ? "Se creeaza contul..." : "Creating account...") : isRo ? "Creeaza cont gratuit" : "Create account for free"}
        </Button>
      </form>
    </AuthCard>
  );
