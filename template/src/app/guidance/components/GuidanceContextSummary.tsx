    ...
    <div className="card p-4 bg-secondary border-primary/20">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="badge-muted text-xs">Gluten · Lactose · Eggs · Soy · Tree Nuts · Fructose · Histamine</span>
        </div>
        <Link href="/profile" className="ml-auto text-xs font-semibold text-primary hover:underline">
          Edit profile
        </Link>
      </div>
    </div>
