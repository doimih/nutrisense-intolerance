    ...
    <div className="card p-6">
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Your name and dietary preference drive all AI recommendations</p>
        </div>
        {/* Avatar */}
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
          <div>
            <label htmlFor="profile-name" className="label-text">Full name</label>
          ...
          <div>
            <label htmlFor="profile-email" className="label-text">Email address</label>
        ...
        <div className="mb-6">
          ...
          <p className="helper-text mb-3">Your dietary pattern affects which foods appear in AI recommendations</p>
