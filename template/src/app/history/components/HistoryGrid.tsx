        ...
        return (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="badge-muted text-xs">{dietLabels[record.diet_preference] || record.diet_preference}</span>
            </div>

            {/* Stats row */}
            <div className="grid grid-cols-3 gap-2 mb-3">
              <div className="text-center p-2 rounded-lg bg-positive-bg/50">
                <p className="text-lg font-bold text-positive tabular-nums">{record.recommended_count}</p>
              ...
              <div className="text-center p-2 rounded-lg bg-muted">
                <p className="text-lg font-bold text-foreground tabular-nums">{record.meal_count}</p>
            ...
            <div className="space-y-1">
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Top picks</p>
