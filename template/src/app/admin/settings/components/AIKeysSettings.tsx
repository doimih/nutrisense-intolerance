...
const initialKeys: AIKey[] = [
  { id: 'openai', provider: 'OpenAI', label: 'OpenAI API Key', value: '', envVar: 'OPENAI_API_KEY' },
  { id: 'gemini', provider: 'Google Gemini', label: 'Gemini API Key', value: '', envVar: 'GEMINI_API_KEY' },
  { id: 'anthropic', provider: 'Anthropic Claude', label: 'Anthropic API Key', value: '', envVar: 'ANTHROPIC_API_KEY' },
  { id: 'perplexity', provider: 'Perplexity', label: 'Perplexity API Key', value: '', envVar: 'PERPLEXITY_API_KEY' },
];
  ...
  return (
    <div className="card p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Configure API keys for AI provider integrations</p>
      </div>
