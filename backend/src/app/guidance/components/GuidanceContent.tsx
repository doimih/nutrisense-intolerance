...
const MOCK_GUIDANCE: GuidanceData = {
  ...
  disclaimer:
    'These suggestions are based on your reported comfort patterns and food preferences. They are for informational and awareness purposes only — not medical advice. Consult your healthcare provider if you have any health concerns.',
};
