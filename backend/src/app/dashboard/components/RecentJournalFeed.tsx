...
function IntensityDot({ value }: { value: number }) {
  ...
  return (
    <span
      className={`inline-flex items-center justify-center w-6 h-6 rounded-full ${color} text-white text-xs font-bold tabular-nums`}
    >
      {value}
    </span>
  );
