        ...
        <div className="flex items-start justify-between p-4 rounded-xl border border-negative/20 bg-negative-bg/30">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Permanently delete your account and all associated data including journal entries,
              guidance history, and intolerance records.
            </p>
          </div>
          <button
      ...
      >
        <div className="space-y-4">
          <div className="flex items-start gap-3 p-3 rounded-lg bg-negative-bg border border-negative/20">
            <svg
              className="w-5 h-5 text-negative flex-shrink-0 mt-0.5"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                All journal entries, guidance history, and intolerance data will be permanently
                deleted.
              </p>
            </div>
          </div>
