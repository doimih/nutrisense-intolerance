...
export default function IntoleranceSelector() {
  ...
  const handleAutoSave = async (_nextSelected: Set<string>) => {
    ...
    <div className="card p-6">
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="badge-blue text-xs font-semibold">{selected.size} selected</span>
        </div>
      </div>
      <p className="text-xs text-muted-foreground mb-4">
        Select all foods your body reacts to. Changes are saved automatically and used to
        personalise your AI guidance.
      </p>
